...
const hits = await Sales.semanticSearchGetValues({ query: 'wireless headphones', limitOutput: { start: 0, stop: 5 } });
...
const hits = await Sales.semanticSearchGetValues({ query: 'wireless headphones', limitOutput: { start: 0, stop: 5 } });
const keys = await Sales.semanticSearchGetKeys({ query: 'wireless headphones', limitOutput: { start: 0, stop: 5 } });

// Optionally drop weak matches by cosine similarity (range [-1, 1]).
const strong = await Sales.semanticSearchGetKeys({ query: 'wireless headphones', limitOutput: { start: 0, stop: 5 }, minScore: 0.35 });
